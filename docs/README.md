...
| [10_requirements/decisions/](10_requirements/decisions/) | 決定 | ADR | **19 件**。Accepted 17 件（うち 4 件はリスク受容あり）／**Proposed 2 件**（ADR-0018 / 0019） |
| [20_basic_design/](20_basic_design/) | 成果物 | モジュール分割・遷移・数値・データ・設定・診断 | **完了**（architecture / screens / balance / data_model / setting / diagnosis）。setting.md は 2026-09-12 に親を母へ確定 |
